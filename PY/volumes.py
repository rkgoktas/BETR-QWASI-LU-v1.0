...
## DEFINE VOLUMES FOR NEW COMPARTMENTS HERE ####################################
    ...
    def V1(self):#Upper Ocean
        vdict={}
        vdict['bulk']=self.par['A']*self.par['perc5']*self.par['h1']
        vdict['sussed']=vdict['bulk']*self.par['fp1']
        vdict['water']=vdict['bulk']-vdict['sussed']
        return(vdict)
    
    def V2(self):#Lower Ocean
        vdict={}
        vdict['bulk']=self.par['A']*self.par['perc5']*(self.par['h'] - self.par['h1'])
        vdict['sussed']=vdict['bulk']*self.par['fp2']
        vdict['water']=vdict['bulk']-vdict['sussed']
        return(vdict)
    
    def V3(self):#sediment
        vdict={}
        vdict['bulk']=self.par['A']*self.par['perc5']*self.par['h7']
...
"""
Unused compartments are commented out. 11.11.2021
