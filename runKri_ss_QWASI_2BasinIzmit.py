...
runID = ['Kri_ss_QWASI_2BasinIzmit'] # output names 
years = [list(range(1,20))]*len(runID)    # range of modeling run (years)

#emisdir = ['Emission_BDE209_10_comparts']  # emission inventory ('Emissions/annual/')
emisfile = ['Emission_Kri_const_discharge.txt'] # emission inventory ('Emissions/')
...
chemnr = [10]  # selection of chemical from chemical properties files
...
for i in range(0, len(runID)):
    ...
    print('\nWriting the result of Central_Sediment and Eastern_Sediment concentration for the run ' + str(runID[i]) + ' with ng/g unit')
    print('Central Sediment Concentration:', Central_Sediment,'ng/g')
    print('Eastern Sediment Concentration:', Eastern_Sediment,'ng/g')
