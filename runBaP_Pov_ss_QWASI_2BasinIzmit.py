...
seasparfile = ['seasonal_parameters_QWASI_2BasinIzmit_const.txt']  #  seasonally varying parameters ('Environment/)
...
chemnr = [47]*len(runID)  # selection of chemical from chemical properties files
